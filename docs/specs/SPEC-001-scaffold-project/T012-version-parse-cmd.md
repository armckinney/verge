...
- `verge parse <version>` parses and normalizes input
...
- [ ] Command signature: `verge parse <version> [flags]`
...
- [ ] Integration test: `verge parse 1.2.3` succeeds
- [ ] Integration test: `verge parse invalid --format json` returns error
